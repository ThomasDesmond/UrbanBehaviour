...
public class processTKY extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jPanel_choosedataset.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Preprocess TKY Data", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Palatino Linotype", 1, 18), new java.awt.Color(255, 255, 102))); // NOI18N
        ...
        jButton_preprocess.setBounds(30, 120, 130, 30);
        ...
        jButton_viewdata.setBounds(30, 210, 130, 30);

        jPanel_main.add(jPanel_choosedataset);
        jPanel_choosedataset.setBounds(30, 60, 750, 450);

        jLabel_title1.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jLabel_bg.setBounds(-100, 0, 910, 830);
    ...
    private void jButton_preprocessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_preprocessActionPerformed
       ...
       try 
        {
            stmt.executeUpdate("TRUNCATE TABLE pre_tkydata");
            stmt.executeUpdate("INSERT into pre_tkydata SELECT * FROM `tky_data`");
    ...
    private void jButton_viewdataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_viewdataActionPerformed
        ...
        try
        {
            rs = stmt.executeQuery("SELECT * from pre_tkydata");
            rsmd=rs.getMetaData();
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            public void run() 
            {
                new processTKY().setVisible(true);
            }
        });
    }
