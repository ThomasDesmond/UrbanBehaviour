...
public class perf_tky extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jPanel_choosedataset.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tokyo City - Geotagged Data", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Palatino Linotype", 1, 18), new java.awt.Color(255, 255, 102))); // NOI18N
        ...
        jScrollPane1.setBounds(270, 60, 460, 230);
        ...
        jPanel_userdetailsLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_userdetailsLayout.createSequentialGroup()
                .addGap(40, 40, 40)
                ...
                .addGap(37, 37, 37)
                .addGroup(jPanel_userdetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextField_lat, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextField_long, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel_userdetails.setBounds(270, 300, 460, 130);
        ...
        jScrollPane2.setBounds(40, 110, 200, 320);

        jPanel_main.add(jPanel_choosedataset);
        jPanel_choosedataset.setBounds(20, 70, 760, 450);
        ...
        jLabel_bg.setBounds(0, 0, 1070, 570);
           ...
           try 
            {
                ...
                rs=stmt.executeQuery("SELECT Venue_catgname FROM `tky_data` GROUP BY Venue_catgname ASC");
                while(rs.next())
                {
    ...
    private void jList_taggeddataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList_taggeddataMouseClicked
        ...
        String listval = jList_taggeddata.getSelectedValue().toString();
         try
            {
                rs = stmt.executeQuery("SELECT * FROM `tky_data` WHERE Venue_catgname='"+listval+"'");
                rsmd=rs.getMetaData();
